...
# Stage v86 images + manifest at a stable same-origin path (asset!() hashes
# would break the hand-written manifest). No-ops to manifest-only if no images.
scripts/v86/stage.sh "$PUBLIC_DIR"
