/* hermes-ws.js — WebSocket-over-relay polyfill for the hermes dashboard iframe.
 *
 * Service workers cannot intercept WebSocket upgrades, so the ingress relay
 * (hermes-sw.js) can never carry a real WS. Instead the SW injects this script
 ...
 * (hermesClients routing); guest-side hermes-ingressd routes /__ws/* to the
 * hermes-wsbridge daemon (127.0.0.1:9219) which speaks real WebSocket to the
