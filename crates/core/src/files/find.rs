...
//! says about a search that found nothing. It is here rather than beside
//! `crate::observe` — which asks the machine what it IS — because the subject a
//! reader arrives with is files; both are `WorkspacePort::exec` (ADR-013).
