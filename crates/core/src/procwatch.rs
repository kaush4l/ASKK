//! ONE NAMED PROCESS — read its output, stop it. Split from `proctable.rs`,
//! which owns the listing of all of them, so both hold the 200-line rule (I12).
//!
...
use crate::process::{blank_as, marked, split_head, word, DIR, STATE};
