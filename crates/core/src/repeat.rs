...
//! recurrence looks like. Split from `transcript.rs`, which owns the
//! conversation, so both hold the 200-line rule (I12).
//!
...
use crate::failure::{failure_kind, failure_line};
