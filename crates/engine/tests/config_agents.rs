...
use askk_engine::config::{load_soul, validate, AgentConfig, SkillConfig, TeamConfig};
...
fn agents_dir() -> PathBuf {
    ...
    Path::new(env!("CARGO_MANIFEST_DIR")).join("../frontend/assets/agents")
}
...
mod agent_md {
    ...
    use askk_engine::config::agent::{BudgetOverride, DEFAULT_LOOP_MAX_TURNS};
    use askk_engine::config::{load_soul, AgentConfig, SkillConfig};
