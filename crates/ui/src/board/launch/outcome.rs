...
use crate::board::read_attrs::{at, cell};
use crate::chat::retry_actions::Recovery;
use crate::ui::Button;
...
pub fn LaunchedRun(
    ...
    // answer to how that turn ended, off the one fold (`core::failure::ending`), and it
    ...
    if moved && ended {
        ...
        // clause is the board row's (`core::failure::within_turn::note`), carried on the row rather
