...
//! instructions are for. Split out of `authoring.rs`, which was at the 200-line
//! rule (I12) and owns the textarea; this file owns the prose beside it.
//!
...
pub fn ask_author(here: bool) -> Element {
    ...
    rsx! {
        ...
        div { class: "row",
            Button {
                variant: "secondary",
                onclick: move |_| crate::route::show(View::Chat, "author"),
