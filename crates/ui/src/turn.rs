...
pub(crate) struct Turn {
    ...
    /// Every token this page has spent, off the projection's own `x-tokens`
    /// header. The shell owns the signal because the meter is in the frame,
    /// and it rides this poll because a meter does not earn a second clock.
