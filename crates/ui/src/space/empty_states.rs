...
//!
//! `space/mod.rs` owns the fetch, the clock and the card; this owns what the
//! card says when there is nothing in it, because R6-15 turned one empty state
//! into three: a space that exists and holds nothing, an agent that is in no space
