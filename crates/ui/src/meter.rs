//! The TOKEN METER: what this page has spent, in the permanent chrome. Split
//! from `frame.rs`, which owns the sandbox pill and the page's heartbeat, so
//! both hold the 200-line rule (I12) — the meter is the one part of the frame
//! that is a number and its formatting rather than a poll.
