...
//!
//! Its own file because an ACTION attached to a state is not the state. Nothing
//! here talks to the core: Retry re-sends through the pane's own `send`, and Open Settings
