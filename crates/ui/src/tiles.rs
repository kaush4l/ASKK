...
//! Dashboard, above the grid. Its own file rather than more of `stage.rs`,
//! which routes the centre column and was at its ceiling (I12).
//!
//! It owns no state and computes nothing: the four tiles are the core's own
//! projection of the fold the board renders (`core::tiles`), fetched through
