...
//! delete. `authoring/mod.rs` owns the pane; this owns the plumbing, which is
//! every crossing of the seam the editor makes and nothing that is drawn.
...
/// same thing. The key is not renamed — see `key_help.rs`.
