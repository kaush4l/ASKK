//! Self-hosted Amarante web font + the ASKK favicon, split out of `app`: the
//! `@font-face` CSS and the hashed asset URLs are a self-contained concern and
//! keep `app.rs` under the file-size cap.

use dioxus::prelude::*;

/// The ASKK tab/bookmark icon (cyan "A" on navy), hashed by `asset!`.
