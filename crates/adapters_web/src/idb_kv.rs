//! `KvStore` over the IndexedDB database `idb.rs` opens. Split from it so both
//! hold the 200-line rule (I12); the atomic `replace_prefix` is the whole
//! reason this half grew.
