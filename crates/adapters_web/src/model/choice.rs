...
//! the CHOICE of endpoint: which entry is picked, what a call would really
//! resolve to, where the profile is stored. `model.rs`, the parent, puts bytes
//! on the wire and attaches the credential; nothing about choice lives there.
//!
