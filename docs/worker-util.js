// Vendored from Eliza (kaush4l/Eliza docs/worker-util.js).
// ASKK adaptation: serveIfInitMsg only re-registers the socket buffer when the
// init message actually carries one — ASKK sends TWO init messages to the VM
// worker (stack.js attach() posts {buf}, boot.js posts {imagename/imagedata}),
// so a buf-less init must not clobber the registered SharedArrayBuffer views.
// SAB layout: 12 + 4096 bytes — streamCtrl@0 streamStatus@4 streamLen@8 data@12.
var streamCtrl;
var streamStatus;
var streamLen;
var streamData;
