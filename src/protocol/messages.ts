 ...
 *
 * **Four messages, not twenty-four, and that is the increment's main decision.**
 * §6.2 and §6.3 table twenty-four; twenty of them have no sender, no receiver
 * or neither until the database (3.4), the stream (3.3), the tools (4.3) or
 * the flow table (4.5) exists. This project's recurring, three-times-recorded
 ...
 * where, is in `PROGRESS.md`'s 3.2 entry.
 *
 ...
 */
export const UNSOLICITED = ['failed', 'fatal'] as const
