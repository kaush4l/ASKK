        ...
        PHASES.get_or_init(|| {
            vec![
                Phase {
                    ...
                    prompt_frame: "SKILL SELECTION phase: from the skill library below, pick the skills relevant to the goal. Pick none if none fit.".into(),
                ...
                Phase {
                    ...
                    prompt_frame: "WORK phase: do the goal, guided by the selected skills.".into(),
                ...
                Phase {
                    ...
                    prompt_frame: "CRITIQUE phase: judge whether the work above meets the goal. Verdict 'pass' or 'revise' with specific feedback.".into(),
                    tool_policy: ToolPolicy::NoTools,
                    loop_mode: LoopMode::OneShot,
                    list_skill_library: false,
                },
...
mod tests {
    ...
    #[test]
    fn critique_is_the_sole_exit_gate() {
        let strategy = SkillsWorkCritiqueStrategy;
        assert_eq!(strategy.gate_phase(), Some(CRITIQUE_IDX));
        assert!(CRITIQUE_IDX < strategy.phases().len());
    }
