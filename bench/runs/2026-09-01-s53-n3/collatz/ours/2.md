...
stop: transport-refused · turns: 1/12 · tokens: 2133 · 35.2s · check: FAIL
...
```
openai-compatible: the reply ran out of tokens while the model was still thinking, so 4,665 characters of its private reasoning arrived on the answer channel
