...
## turn 1 — reply (210 tokens, 9.6s, whole)
...
## turn 2 — reply (1200 tokens, 35.8s, thinking)
...
```
the transport: the reply ran out of tokens while the model was still thinking, so 4,954 characters of its private reasoning arrived on the answer channel
