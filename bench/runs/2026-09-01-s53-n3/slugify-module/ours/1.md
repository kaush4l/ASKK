...
stop: transport-refused · turns: 1/12 · tokens: 2151 · 35.7s · check: FAIL
...
```
openai-compatible: the reply ran out of tokens while the model was still thinking, so 4,683 characters of its private reasoning arrived on the answer channel
