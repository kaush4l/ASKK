...
stop: transport-refused · turns: 2/12 · tokens: 3356 · 45.4s · check: FAIL
...
```
openai-compatible: the reply ran out of tokens while the model was still thinking, so 4,954 characters of its private reasoning arrived on the answer channel
