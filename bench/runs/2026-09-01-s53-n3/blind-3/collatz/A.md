...
## turn 1 — reply (1200 tokens, 35.5s, thinking)
...
```
the transport: the reply ran out of tokens while the model was still thinking, so 4,729 characters of its private reasoning arrived on the answer channel
